/**
 * Precise Finish Painters - Main JavaScript
 * Professional residential painting website
 */
...
(function() {
    ...
    function setLanguage(lang) {
        ...
        // Save preference
        localStorage.setItem('precise-finish-lang', lang);
    }
    ...
    function updateWhatsAppMessage(lang) {
        ...
        if (whatsappBtn) {
            ...
            const baseHref = 'https://wa.me/+19546637344';
    ...
    function init() {
        ...
        const savedLang = localStorage.getItem('precise-finish-lang') || localStorage.getItem('roco-lang') || 'en';
